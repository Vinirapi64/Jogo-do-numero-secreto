...
function exibirTextoNaTela(){
    ...
    exibirTexto('.texto__paragrafo', 'Digite um numero entre 1 e 55: ');
}
...
function gerarNumero(){
    let gerarNumeroAleatorio = parseInt(Math.random() * 55 + 1); // Aqui, o que eu fiz, na função, eu inclementei esse includes, que verifica se já não tem o numero que gerou no array, melhor que o python
